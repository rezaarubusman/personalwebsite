    ...
    <footer className="border-t bg-black text-white mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
          ...
          <p className="flex flex-col text-center text-lg text-muted-foreground">
            Tugas Code Challenge 2
          </p>  
          <div className="flex flex-col items-center gap-6">
            <a
              href="https://linkedin.com/in/fahreza-aqsa-arubusman"
              className="text-lg text-muted-foreground hover:text-gray-100 transition-colors"
            >
              LinkedIn
            </a>
            <a
              href="mailto:fahre@example.com"
              className="text-lg text-muted-foreground hover:text-gray-100 transition-colors"
            >
              Email
            </a>
